...
final class AccountHolder implements DomainObjectInterface
{
    ...
    public static function fromArray(array $json): AccountHolder
    {
        ...
        return new AccountHolder(
            ...
            $accountHolder['email'],
            $accountHolder['suspended'],
            $accountHolder['beta'],
            $accountHolder['languageCode'],
            $accountHolder['phoneNumber'] ?? null,
            $accountHolder['address1'] ??  null,
            $accountHolder['address2'] ?? null,
            $accountHolder['city']?? null,
            $accountHolder['postcode']?? null,
            $accountHolder['country']?? null,
            $accountHolder['newsletter'],
            $accountHolder['currencyRef'],
            $accountHolder['state']?? null,
            Capabilities::fromArray($accountHolder['capabilities']),
            $accountHolder['accountPaymentMethodRef']?? null,
            $accountHolder['cpfNumber']?? null,
            $accountHolder['cpfCompany'],
            $accountHolder['deleted'],
            $accountHolder['storageBytesUsed'],
            $accountHolder['created']?? null,
            $accountHolder['lastLogin']?? null,
